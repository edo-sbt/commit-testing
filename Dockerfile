...
RUN sudo NR_INSTALL_KEY="2bd895f182e7998982392a29684afdc9d319a992" NR_INSTALL_SILENT=true NR_INSTALL_PHPLIST=/opt/php71/bin;/opt/php72/bin newrelic-install install
